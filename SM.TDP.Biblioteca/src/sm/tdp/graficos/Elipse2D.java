...
/**
 * Esta clase contiene los atributos que definen un objeto de tipo Elipse2D
 * @author Tatiana Daniela Pastorini
 * @version 1.0
 */
public class Elipse2D extends MiFiguraRellena2D{
     ...
     */
    public Elipse2D(Point2D ini, Point2D fin, boolean liso, boolean transparente,
        ...
        this.punto_ini = ini;
        this.punto_fin = fin;
        this.s = new Ellipse2D.Double(ini.getX(), ini.getY(), 0, 0);
        this.tipo_figura = FIGURA_ELIPSE;
    ...
    /**
     * Dibujado de forma de tipo Elipse2D
    ...
    public void setLocalizacionShape(Point2D ini, Point2D fin) {
        ...
        ((Ellipse2D)s).setFrameFromDiagonal(ini, fin);
    }
